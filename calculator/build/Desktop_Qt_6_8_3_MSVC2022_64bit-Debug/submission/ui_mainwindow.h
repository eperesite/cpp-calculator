...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(cmb_controller, 0, 0, 1, 4);

        l_memory = new QLabel(centralwidget);
        l_memory->setObjectName("l_memory");

        gridLayout->addWidget(l_memory, 1, 0, 1, 4);
        ...
        gridLayout->addWidget(l_formula, 2, 0, 1, 4);
        ...
        gridLayout->addWidget(tb_extra, 8, 0, 1, 1);
        ...
        gridLayout->addWidget(btnDiv, 9, 3, 1, 1);

        btnSign = new QPushButton(centralwidget);
        btnSign->setObjectName("btnSign");

        gridLayout->addWidget(btnSign, 9, 2, 1, 1);

        btnClear = new QPushButton(centralwidget);
        btnClear->setObjectName("btnClear");

        gridLayout->addWidget(btnClear, 9, 0, 1, 2);
